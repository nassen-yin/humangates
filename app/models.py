...
SERVICE_REGISTRY = {
    ...
    "team_building": {
        "name": "团建策划与拓展",
        "description": "企业团建活动策划与执行——拓展训练、趣味运动会、徒步露营、城市探索。方案定制→场地预定→执行落地→效果反馈。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "3-14",
        "price_range": "100-500/人",
        "capabilities": None,
    },
    "business_dining": {
        "name": "商务宴请与接待",
        "description": "商务宴请/接待全流程安排——按预算、口味、位置推荐餐厅包间，含礼品搭配、接送安排、伴手礼。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "1-3",
        "price_range": "按预算定制",
    ...
    "corporate_procurement": {
        "name": "企业采购与福利",
        "description": "办公用品集采、员工福利方案、节日礼盒定制、企业礼品采购。比价→下单→配送上门，一条龙搞定。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "3-7",
        "price_range": "按需报价",
    ...
    "logistics_delivery": {
        "name": "物流配送与货运",
        "description": "文件急送、设备运输、企业搬迁、仓储配送。按物品类型匹配最优运力，全程追踪。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "1-5",
        "price_range": "按距离/重量",
    ...
    "sales_outsourcing": {
        "name": "销售外包与渠道拓展",
        "description": "企业销售外包、渠道代理匹配、地推团队对接。按效果付费，覆盖全国主要城市。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "持续服务",
        "price_range": "按效果付费",
    ...
    "third_party_operations": {
        "name": "第三方代运营",
        "description": "抖店代运营、公众号代运营、小红书代投、天猫/京东店铺代运营。含内容策划→投放优化→数据分析。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "持续服务",
    ...
    "recruitment_outsourcing": {
        "name": "猎头与招聘外包",
        "description": "中高端人才猎头、批量招聘外包、岗位JD撰写、简历筛选、面试安排全流程。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "7-30",
        "price_range": "年薪15-25%",
    ...
    "corporate_training": {
        "name": "企业内训与拓展",
        "description": "企业管理培训、专业技能培训、公开课定制。匹配讲师→定课程→组织培训→效果评估。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "7-14",
    ...
    "manufacturing_sampling": {
        "name": "代工打样与小批量",
        "description": "对接工厂资源——样品打样、小批量生产、包装定制。按需求匹配产能，把控交期和质量。",
        "status": "planning",
        "schema_model": None,
    ...
    "bidding_service": {
        "name": "招投标全流程服务",
        "description": "标书代写、资质预审、投标陪跑、中标后履约跟踪。覆盖政府采购、工程招标、企业采购。",
        "status": "planning",
        "schema_model": None,
        "estimated_days": "视项目周期",
        "price_range": "2000-10000/项目",
        "capabilities": None,
    },
}
